...
const WEBSITE_PIN = "2401";              // ← GANTI PIN

/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   2. NAMA PENERIMA
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Nama yang muncul di halaman utama (hero).                      */
const RECIPIENT_NAME = "Dian";           // ← GANTI NAMA
...
const MEMORIES = [
  {
    ...
    text:  "dulu kamu cuma adek kelasku di SMA, and we happened to be in the same student council. honestly, aku nggak terlalu notice kamu waktu itu, karena kita sama-sama sibuk dengan our own lives.",
  },
  {
    depth: "8m",
    year:  "Chapter Two",
    title: "Different paths",
    text:  "after graduation, life took us in different directions. aku kuliah di Jogja, kamu menjalani perjalananmu sendiri di Samarinda. for years, we were just two people connected by an Instagram follow.",
  },
  {
    depth: "16m",
    year:  "Chapter Three",
    title: "Meeting again",
    text:  "eight years later, a simple story reply brought us back together. awalnya cuma ngobrol biasa, but ternyata ada so many stories we’ve never shared before. from one conversation to another, rasanya seperti mengejar waktu yang hilang selama bertahun-tahun.",
  },
  {
    depth: "24m",
    year:  "Chapter Four",
    title: "Still writing",
    text:  "lewat endless chats dan deep conversations, kita menemukan connection yang nggak pernah kita duga sebelumnya. maybe we haven’t given this story a name yet, but aku bersyukur karena setelah sekian lama, semesta mempertemukan kita kembali.",
  },
];
